...
If you believe you have found a security issue in `skills-registry`, please report it **privately** via [GitHub Security Advisories](https://github.com/nikships/skills-registry/security/advisories/new).
